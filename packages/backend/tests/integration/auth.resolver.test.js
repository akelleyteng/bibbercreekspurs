...
describe('Auth Resolver Integration Tests', () => {
    ...
    afterAll(async () => {
        ...
        await database_1.default.query('DELETE FROM users WHERE email LIKE $1', ['test%@example.com']);
    });
    afterEach(async () => {
    ...
    `;
        it('should register a new user successfully', async () => {
            ...
            expect(response.body.data.register.user.role).toBe(shared_1.Role.MEMBER);
