...
interface EnvConfig {
  ...
  GOOGLE_DRIVE_PRESENTATIONS_FOLDER_ID: string;
  GOOGLE_DRIVE_PRESENTATIONS_IMAGES_FOLDER_ID: string;
  GOOGLE_DRIVE_PRESENTATIONS_RECORDINGS_FOLDER_ID: string;
  GOOGLE_DRIVE_MEETINGS_FOLDER_ID: string;
  GOOGLE_DRIVE_AGENDA_TEMPLATE_ID: string;
  GOOGLE_DRIVE_OWNER_REFRESH_TOKEN: string;
  GOOGLE_CALENDAR_ID: string;
  GOOGLE_CALENDAR_OWNER_REFRESH_TOKEN: string;
...
export const env: EnvConfig = {
  ...
  GOOGLE_DRIVE_PRESENTATIONS_FOLDER_ID: getEnvVar('GOOGLE_DRIVE_PRESENTATIONS_FOLDER_ID', ''),
  GOOGLE_DRIVE_PRESENTATIONS_IMAGES_FOLDER_ID: getEnvVar('GOOGLE_DRIVE_PRESENTATIONS_IMAGES_FOLDER_ID', ''),
  GOOGLE_DRIVE_PRESENTATIONS_RECORDINGS_FOLDER_ID: getEnvVar('GOOGLE_DRIVE_PRESENTATIONS_RECORDINGS_FOLDER_ID', ''),
  GOOGLE_DRIVE_MEETINGS_FOLDER_ID: getEnvVar('GOOGLE_DRIVE_MEETINGS_FOLDER_ID', ''),
  GOOGLE_DRIVE_AGENDA_TEMPLATE_ID: getEnvVar('GOOGLE_DRIVE_AGENDA_TEMPLATE_ID', ''),
  GOOGLE_DRIVE_OWNER_REFRESH_TOKEN: getEnvVar('GOOGLE_DRIVE_OWNER_REFRESH_TOKEN', ''),
  GOOGLE_CALENDAR_ID: getEnvVar('GOOGLE_CALENDAR_ID', ''),
  GOOGLE_CALENDAR_OWNER_REFRESH_TOKEN: getEnvVar('GOOGLE_CALENDAR_OWNER_REFRESH_TOKEN', ''),
